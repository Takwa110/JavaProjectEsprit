...
public class LoginController {
        ...
        try {
            ...
            if (utilisateur == null) {
                ...
                if (utilisateur instanceof Admin) {
                    redirectToPage("/org/esprit/projets/MainViewAdmin.fxml", "Tableau de bord Admin");
                } else if (utilisateur instanceof Enseignant) {
                    redirectToPage("/org/esprit/projets/MainViewEnseignant.fxml", "Tableau de bord Enseignant");
                } else if (utilisateur instanceof Etudiant) {
                    redirectToPage("/org/esprit/projets/MainView.fxml", "Tableau de bord Étudiant");
                }
            }
    ...
    protected void handleCreateAccountButtonAction(ActionEvent event) {
        redirectToPage("/org/esprit/projets/CreateAccountPage.fxml", "Créer un compte");
    }
    ...
    protected void handleForgotPasswordAction(ActionEvent event) {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/org/esprit/projets/ForgotPasswordPage.fxml"));
